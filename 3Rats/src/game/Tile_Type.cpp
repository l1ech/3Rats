...
TileType::TileType(std::string texture, bool exit, bool hole, bool entrance, int h) 
    ...
    std::cout << "TileType constructor: Created TileType with texture: " << texture_path 
...
void TileType::applyToTile(Tile& tile) const {
    ...
    std::cout << "Applying TileType to Tile: "
    ...
    std::cout << "Tile updated with Texture: " << texture_path
              << ", Exit: " << tile.is_exit
              << ", Hole: " << tile.is_hole
